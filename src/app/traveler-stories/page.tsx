...
export const metadata: Metadata = {
  ...
  description: "Read real reviews and stories from travelers who have explored Pakistan with TravelBug.pk. Photographers-led memories from across the country.",
